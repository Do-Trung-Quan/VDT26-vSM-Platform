...
import { ListChecks, LayoutDashboard, Users, Building2, User, LogOut } from "lucide-react";
    ...
    <aside className="w-[244px] flex-none bg-navy flex flex-col sticky top-0 h-screen">
      ...
      <div className="p-3 border-t border-white/[0.07]">
        <button onClick={handleLogout}
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-[7px] text-[14px] font-medium text-[#9BA3B4] hover:bg-white/[0.06] hover:text-white transition-colors">
          <LogOut size={18} />
          <span>Đăng xuất</span>
        </button>
      </div>
