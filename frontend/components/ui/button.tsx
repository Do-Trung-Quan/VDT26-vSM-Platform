  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:     "border border-line bg-white text-tx-mid hover:bg-surface hover:border-line-dark",
        ghost:       "hover:bg-surface text-tx-mid",
        destructive: "bg-brand text-white hover:bg-brand-dark",
        link:        "text-brand underline-offset-4 hover:underline",
        secondary:   "bg-surface text-tx-dark hover:bg-line",
      },
      size: {
